        ...
        <Col xl={6} lg={12} md={12} xs={12} className="mb-6">
            <Card>
                <Card.Body>
                    ...
                    {/* Check if ProjectsContributionsData is an array and has items */}
                    {Array.isArray(ProjectsContributionsData) && ProjectsContributionsData.length > 0 ? (
                        ...
                        <p>No data available</p> // Display message if no valid data
                    )}
                </Card.Body>
            </Card>
        </Col>
