      ...
      <Col xxl={4} lg={5} md={4} xs={12} className="py-8 py-xl-0">
        ...
        <Card className="smooth-shadow-md" 
          style={{
           ...
           background: "rgba(90, 85, 85, 0.57)", // Glassmorphism effect
            ...
            <Form>
              ...
              <div>
                ...
                <div className="d-grid">
                  <Button variant="primary" type="submit" style={{ color: "#F5F5DC" }}>Create Free Account</Button>
                </div>
                <div className="d-md-flex justify-content-between mt-4">
                  <div className="mb-2 mb-md-0">
                    <Link href="/authentication/sign-in" className="fs-5" style={{ color: "#F5F5DC" }}>Already member? Login </Link>
                  </div>
                  <div>
